...
# Set xvlog options
xvlog_opts="--incr --relax -L axi_vip_v1_1_12 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_14 -L xilinx_vip"
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6f02.protoinst" -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
